...
st.write("Aplikasi pemantau kelembapan & angin real-time untuk Cicurug.")
...
try:
    ...
    wind_speed = respons["current"]["wind_speed_10m"]
...
gambar_teks.text((80, 420), "Today's average", fill=(255, 255, 255, 150), font=font_sedang)
gambar_teks.text((80, 480), f"{rata_rata}%", fill=(255, 255, 255, 255), font=font_SUPER_BESAR)
...
st.download_button("📥 Download Gambar PNG", buf.getvalue(), "Grafik_Cuaca_Cicurug.png", "image/png")
